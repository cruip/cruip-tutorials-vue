...
<template>
  ...
  <Footer />
  <Banner tutorialUrl="https://cruip.com/how-to-create-a-spotlight-card-hover-effect-with-tailwind-css/" downloadUrl="https://github.com/cruip/cruip-tutorials-vue/blob/main/src/components/Spotlight.vue" />
</template>